const reassurances = [
  {
    ...
    description: 'Expédition sous 48h dans un emballage renforcé.',
    icon: (
  ...
  },
  {
    ...
    description: 'Carte bancaire, PayPal, Apple Pay.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: 'Papier mat épais 200g, encres haute qualité.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
